...
Purpose: Define how Praxis maps abstract artifacts into concrete runtime targets for Codex and Claude Code. Future Gemini integration remains outside this runtime-file contract until a separate adoption change extends it.
...
- Praxis does not claim that Codex and Claude Code are semantically identical.
...
- any future runtime-file contract extension, if adopted
...
Lifecycle:
Declared in the runtime registry and used by profiles, plans, and UI surfaces.
...
Supported first-class runtime-file install targets are:
...
- any legacy Gemini runtime-file ids, slots, roots, or profiles carried forward from older state
...
- Praxis must not invent future runtime-file destinations outside the adopted contract
...
- explicit surfacing that the runtime-file contract currently stops at Codex and Claude
...
- unsupported legacy runtime-file targets remain visible as scope-boundary errors rather than being silently coerced
...
- extending the runtime-file install boundary beyond Codex and Claude
...
- never treat non-adopted future integrations as runtime-file targets
...
- future integration work must be separated from runtime-file install contract work
...
- future runtime-file support after a concrete contract is documented
...
- a future runtime-file integration becomes concrete enough to standardize
